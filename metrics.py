...
def calculate_metrics(logits:np.ndarray, y_trues: np.ndarray):
    ...
    precision = precision_score(y_trues, y_preds, average="binary", zero_division=0.0)
    recall = recall_score(y_trues, y_preds, average="binary", zero_division=0.0)
    f1 = f1_score(y_trues, y_preds, average="binary", zero_division=0.0)
